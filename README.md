...
## Dataset and Model
Our dataset and model can be dowloaded [here](https://huggingface.co/collections/UKPLab/MAGneT). The dataset can also be downloaded at [TUdatalib](https://tudatalib.ulb.tu-darmstadt.de/handle/tudatalib/5072)
