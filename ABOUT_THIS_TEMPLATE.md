...
- 🎯 Entry points to execute your program using `python -m <arxiv2025_mascs_gen>` with basic CLI argument parsing;
- 🔄 Continuous integration using [Github Actions](https://github.com/UKPLab/arxiv2025-MASCS-Gen/actions) with jobs to check, lint and test your project;
...
│
├───arxiv2025_mascs_gen             # The main python package for the project
...
You should create new files and subpackages inside arxiv2025_mascs_gen and implement your functionalities there. Remember to add what you write to `__init__.py` so that the imports work smoothly. Take a look at `base.py` and `__init__.py` to understand how it works.
...
It contains [GitHub Actions](https://docs.github.com/en/actions) that are executed automatically when pushing your code. You can see results for your repository [here](https://github.com/UKPLab/arxiv2025-MASCS-Gen/actions).
